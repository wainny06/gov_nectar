...
const files=['notion-sync.js','lib/notion-records.js','index.html','app.js','style.css','lib/sources.js','lib/curated-notices.js','lib/keyword-filter.js','planning.html','planning.js','planning.css','lib/planning-data.js','beauty.html','lib/beauty-data.js'];
